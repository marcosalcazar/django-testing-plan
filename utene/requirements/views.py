...
from requirements.forms import RequirementPreConditionFormSet,\
    ...
    RequirementAlternativePathForm, RequirementAlternativePathStepFormSet
...
class RequirementAlternativePathStepCreateView(CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['formset'] = RequirementAlternativePathStepFormSet(
            self.request.POST or None
        )
        return context
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid() and formset.is_valid():
            ...
            for s in steps:
                s.alternative_path = self.object
                s.save()
