...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestPlanExecution'
        db.create_table(u'testing_testplanexecution', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('test_plan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['testing.TestPlan'])),
            ('test_case', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['testing.TestCase'])),
            ('qa_resource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'testing', ['TestPlanExecution'])


    def backwards(self, orm):
        # Deleting model 'TestPlanExecution'
        db.delete_table(u'testing_testplanexecution')
    ...
    models = {
        ...
        u'testing.testplanexecution': {
            'Meta': {'object_name': 'TestPlanExecution'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'observations': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'qa_resource': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'result': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'test_case': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['testing.TestCase']"}),
            'test_plan': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['testing.TestPlan']"})
        }
    }
