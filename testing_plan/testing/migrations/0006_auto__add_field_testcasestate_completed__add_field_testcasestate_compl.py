...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCaseState.completed'
        db.add_column(u'testing_testcasestate', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TestCaseState.completed_by'
        db.add_column(u'testing_testcasestate', 'completed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='states_completed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'TestCaseState.verified'
        db.add_column(u'testing_testcasestate', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TestCaseState.verified_by'
        db.add_column(u'testing_testcasestate', 'verified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='states_verified', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCaseState.completed'
        db.delete_column(u'testing_testcasestate', 'completed')

        # Deleting field 'TestCaseState.completed_by'
        db.delete_column(u'testing_testcasestate', 'completed_by_id')

        # Deleting field 'TestCaseState.verified'
        db.delete_column(u'testing_testcasestate', 'verified')

        # Deleting field 'TestCaseState.verified_by'
        db.delete_column(u'testing_testcasestate', 'verified_by_id')
    ...
    models = {
        ...
        u'testing.testcasestate': {
            ...
            'corrective_action': ('django.db.models.fields.TextField', [], {}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
