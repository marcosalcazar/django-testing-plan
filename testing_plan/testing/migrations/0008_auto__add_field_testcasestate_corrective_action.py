...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCaseState.corrective_action'
        db.add_column(u'testing_testcasestate', 'corrective_action',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCaseState.corrective_action'
        db.delete_column(u'testing_testcasestate', 'corrective_action')
    ...
    models = {
        ...
        u'testing.testcasestate': {
            ...
            'corrective_action': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
