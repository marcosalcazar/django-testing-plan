...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestCaseState'
        db.create_table(u'testing_testcasestate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('test_case', self.gf('django.db.models.fields.related.ForeignKey')(related_name='states', to=orm['testing.TestCase'])),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('corrective_action', self.gf('django.db.models.fields.TextField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'testing', ['TestCaseState'])


    def backwards(self, orm):
        # Deleting model 'TestCaseState'
        db.delete_table(u'testing_testcasestate')
